...
public class BouyomiChan4J {
	...
	public boolean talk(String message) {
		return talk(host, port, (short) -1, (short) -1, (short) -1, (short) 0, message);
	}
	...
	private boolean send(String host, int port, byte[] data) {
		Socket socket = null;
...
//			System.out.println("接続しました" + socket.getRemoteSocketAddress());
			...
			JOptionPane.showMessageDialog(frame, "棒読みちゃんに接続できないよ。起動しているか確認してね。", "エラー",
...
//			System.out.println("終了します");
	...
	private boolean talk(String host, int port, short volume, short speed, short tone, short voice, String message) {
